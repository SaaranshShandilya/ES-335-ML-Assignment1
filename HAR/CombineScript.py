...
train_path = r"D:\Mtech_Sem1\ML\human+activity+recognition+using+smartphones\UCI HAR Dataset\UCI HAR Dataset/train"
test_path =r"D:\Mtech_Sem1\ML\human+activity+recognition+using+smartphones\UCI HAR Dataset\UCI HAR Dataset/test"
